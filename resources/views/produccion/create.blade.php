...
@section('contenido')
  ...
  <form method="POST" action="{{route('pedidos.store')}}" class="container mt-5" style="max-width: 800px;">
    ...
    <div class="mb-3">
      ...
      <a href="{{route('pedidos.index')}}"><button type="button" class="btn btn-outline-primary mb-3"><i class="fa-solid fa-arrow-up-right-from-square icon"></i>Volver</button></a>
    </div>
  </form>
