...
@section('contenido')
  ...
  <form method="POST" action="{{route('maquinas.store')}}" class="container mt-5" style="max-width: 800px;">
    ...
    <div class="mb-3">
      <button type="submit" class="btn btn-primary mb-3">Insertar máquina</button>
      <a href="{{route('maquinas.index')}}"><button type="button" class="btn btn-primary mb-3">Volver</button></a>
    </div>
  </form>
