...
<div class="row justify-content-center p-3">
  ...
  <div class="col  justify-content-center">
    <div class="row justify-content-center mb-3">
      <a href="{{route('maquinas.edit',$maquina->id)}}" class="col-auto"><button class=" btn btn-primary mb-3">Modificar info</button></a>
      <a href="{{route('maquinas.index')}}"class="col-auto"><button type="button" class=" btn btn-primary mb-3">Volver</button></a>
    </div>     
    <div class="row ">
